...
export default function Home() {
	return (
		<>
			<>
				<section className="bg-white minimal-hero position-relative zindex-1 overflow-hidden">
					<div className="container">
						<div className="row align-items-center justify-content-between">
							<div className="col-xl-6 col-lg-8" data-aos="fade-right">
								<div className="mn-hero-content">
									<h4 className="mn-subtitle">
										Gazduire Web SSD cu Domenii gratuite{" "}
										<img src="/assets/img/shapes/arrow-yellow.png" alt="arrow" className="ms-1" />
									</h4>
									<h1 className="display-3 fw-bold mn-hero-title">
										We're Provide Web <mark>Hosting</mark> Solutions Agency
									</h1>
									<p>
							...
							<div className="col-xl-6" data-aos-easing="ease-in-out" data-aos="fade-left">
								<div className="hero-slider-wrapper overflow-hidden mt-60">
									<img className="w-100" src="./assets/img/banner-bg.png" alt="" />
								</div>
							</div>
						</div>
					</div>
					<img
						...
						src="/assets/img/shapes/mn-hero-circle.png"
						alt="hero shape"
						className="position-absolute end-0 top-0 zindex--1 w-50 d-none d-sm-block"
					/>
				</section>
						...
						<div className="row justify-content-center">
							<div className="col-lg-12">
								<div className="section-heading text-center mb-30">
									<div className="tab-switch-btn d-inline-flex align-items-center justify-content-center position-relative mt-4">
										...
										<input type="checkbox" className="switch-input position-absolute" />
							...
							<div className="col-md-4 col-lg-2 equal-width-columns" data-aos="fade-up">
								<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
									...
									<h4 className="h2 mt-2 yearly-price">
										€20<span>/yr</span>
									</h4>
									...
									<button className="expand-btn mt-4">
							...
							<div className="col-md-4 col-lg-2 equal-width-columns" data-aos="fade-up">
								<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
									...
									<button className="expand-btn mt-4 active">
										...
										<div className="tab-content mt-4">
											<div className="tab-pane fade active show p" id="hosting_service" role="tabpanel">
												...
												<div className="tab-content-main py-3 ms-5">
													...
													<ul className="border-0">
														...
														<li>
															<strong>Control Panel:</strong> cPanel, LiteSpeed, JetBackup, Imunify360,
													...
													<div>
														...
														<p>
															Pentru a verifica cu ajutorul acestui binecunoscut serviciu de monitorizare,
											...
											<div className="tab-pane fade " id="hosting_service1" role="tabpanel">
												<ul style={{ border: "none", listStyle: "disc" }}>
													...
													<li>
														La pasul urmator vi se va afisa o proforma. Proforma va fi trimisa automat si pe mail
														insa va rugam sa verificati si in Bulk/Spam daca aveti e-mail pe Yahoo sau alti
														provideri gratuiti.{" "}
													</li>
													<li>
													...
													<li>
														...
														gazduire in cel mai scurt timp. Domeniile se propaga in mod normal in cateva ore insa in
														unele retele aceasta operatiune poate dura si cateva zile.{" "}
													</li>
													...
													<li>
														...
														inapoiati unul semnat (si stampilat in cazul firmelor) in termen de 7 zile de la
														primire.{" "}
													</li>
												</ul>
											</div>
											<div className="tab-pane fade " id="hosting_service2" role="tabpanel">
												...
												<ul className="border-0" style={{ listStyle: "disc" }}>
													...
													<li>
														...
														<a href="http://www.brd.ro/banca/retea-unitati/">
															http://www.brd.ro/banca/retea-unitati/
														</a>
													</li>
													<p className="my-2">
														Faceti click pe judetul dvs si vi se va prezenta o lista cu unitatile disponibile (cate
														10 pe o pagina - verificati daca nu sunt mai multe pagini). Pentru orice depunere de
														numerar in contul nostru aveti nevoie de numele firmei noastre, contul, banca, numarul
														proforma (pentru "Detalii operatiune") si CNP-ul dvs.{" "}
													</p>
													<li>prin card</li>
													<p className="my-2">
												...
												<ul className="border-0" style={{ listStyle: "disc" }}>
													<li>
														Puteti plati cu numerar la oricare filiala BRD (vedeti exemplul de foaie de depunere de
														la baza paginii). Lista completa a filialelor:{" "}
													</li>
													<br />
													<li>
														<a href="http://www.brd.ro/banca/retea-unitati/">
													...
													<p className="my-2">
														(faceti click pe judetul dvs si vi se va prezenta o lista cu filiale din zona - cate 10
											...
											<div className="tab-pane fade " id="hosting_service3" role="tabpanel">
												<div className="tab-content-main py-3 ms-5">
													...
													<p>
														Dupa plasarea comenzii vi se va prezenta la ultimul pas proforma aferenta pe care o
														puteti plati pe loc cu cardul sau ulterior prin depunere numerar la orice agentie BRD
														sau prin Ordin de Plata din orice alta banca.{" "}
													</p>
													<h4 className="my-3"> Operarea comenzii </h4>
													<p>
														Dupa intrarea banilor in contul nostru (aceasta etapa dureaza maxim cateva ore
														lucratoare in cazul platilor prin card sau din BRD si pana la 1-2 zile lucratoare in
														cazul platilor din alte banci), in circa 15-30 minute va vom opera comanda (cu cateva
														exceptii; spre exemplu, nu se opereaza comenzi in afara programului normal de lucru).{" "}
													</p>
													...
													<ul className="border-0" style={{ listStyle: "disc" }}>
														...
														<li>
															{" "}
															in cazul in care ati comandat un domeniu .ro se va propaga in mod uzual in cateva
															ore.{" "}
														</li>
													</ul>
												</div>
						...
						<div className="row justify-content-center align-items-center">
							<div className="col-xl-8">
								<div className="hm7-feedback-wrapper mb-4" data-aos="fade-up">
										...
										<div className="swiper-wrapper">
												...
												<div className="clients_feedback">
													<span className="rating_star">
														<p className="mb-0 mt-3">
															...
															Deasemenea au crescut si cerintele pentru hosting, in momentul de fata fiind nevoie
															de o solutie profesionala care sa ne asigure stabilitate in fata clientilor nostri.
															Firma ne-a fost alaturi si ne-a sustinut in tot acest timp, cu solutii tehnice
															adecvate. Punctul forte al celor de la RedHost este suportul tehnic ireprosabil,
															orice problema aparuta sau orice solicitare a noastra rezolvandu-se in timp record.
															Seriozitatea si promtitudinea si nu in ultimul rand calitatea serviciilor, celor de
															la RedHost sunt principalele argumente care ne fac sa continuam aceasta colaborare,
															speram pe un termen cat mai lung.
														</p>
													</span>
												</div>
											</div>
												...
												<div className="clients_feedback">
													<span className="rating_star">
														<p className="mb-0 mt-3">
															...
															promptitudinea, suportul tehnic si calitatea serviciilor ireprosabile. Sfaturile
															utile, operativitatea si rabdarea le-am gasit aici din momentul in care am inceput
															colaborarea cu dl. Banu. In cateva cuvinte am scapat de grija web hosting-ului.
														</p>
														<hr />
											...
											<div className="hm7-feedback-single border rounded d-flex align-items-center bg-white swiper-slide">
												...
												<div className="clients_feedback">
													<span className="rating_star">
														<p className="mb-0 mt-3">
															Multumesc site-ului RedHost.ro pentru sustinerea proiectului MateInfo.ro ! In cei 3
															ani de cand colaboram au dovedit ca sunt adevarati PROFESIONISTI iar acum, prin
															sprijinul lor, suntem cel mai bun site de Matematica din Romania !{" "}
														</p>
														<hr />
														<div className="d-flex justify-content-start">
															<div className="mt-2">
											...
											<div className="hm7-feedback-single border rounded d-flex align-items-center bg-white swiper-slide">
												...
												<div className="clients_feedback">
													<span className="rating_star">
														<p className="mb-0 mt-3">
															Cu perseverenta si calitatea serviciilor REDHOST site-ul Geomobila.ro a ajuns pe
															primul loc si cel mai bine vazut site pentru -mobila din pal-.Colaborarea noastra cu
															echipa REDHOST a fost si va ramane una dintre legaturile de baza a afacerii noastre,
															caci fara un site bun, o gazduire buna si o echipa perseverenta in spate nu putem fi
															cei mai buni. Geomobila s.r.l sustine si promoveaza serviciile REDHOST ! Raspunsurile
															promte la inrebarile noastre si accesul non-stop la serviciile dumneavoastra ne aduc
															satisfactie si nu ne face decat sa va uram mult succes si in viitorii ani!
														</p>
														<hr />
														<div className="d-flex justify-content-start">
															<div className="mt-2">
											...
											<div className="hm7-feedback-single border rounded d-flex align-items-center bg-white swiper-slide">
												...
												<div className="clients_feedback">
													<span className="rating_star">
														<p className="mb-0 mt-3">
															Our experiences with RedHost are very good, trustworthy and a quick service. The
															company fullfilled our wishes in a pleasant way and in a short time. Mr. Banu knows
															the business very well and also the service afterwards is very good. In RedHost we
															have found a reliable company to do business with. If you are looking for a
															webdesigner we can recommend this firm.
														</p>
														<hr />
														<div className="d-flex justify-content-start">
															<div className="mt-2">
									...
									<button className="hm7-feedback-prev hm7-feedback-slide-control">
										<i className="fas fa-arrow-left"></i>
									</button>
									<button className="hm7-feedback-next hm7-feedback-slide-control">
								...
								<div className="sh-cp-left position-relative zindex-1 mb-5 mb-lg-0">
									<div className="accordion cp-accordion" id="">
										<div className="accordion-single">
											...
											<div className="accordion-collapse collapse" id="one" data-bs-parent="#">
												<div className="accordion-body">
													<p>
														Over 100 of the very best applications, including WordPress, all ready to install with
														just a click of the mouse or the tap of the finger.
													</p>
													<a href="pricing">
														<i className="fa-solid fa-circle-arrow-right"></i> Order Now
													</a>
												</div>
											</div>
										</div>
										<div className="accordion-single">
											...
											<div className="accordion-collapse collapse" id="two" data-bs-parent="#">
												<div className="accordion-body">
													<p>
														Over 100 of the very best applications, including WordPress, all ready to install with
														just a click of the mouse or the tap of the finger.
									...
									<div className="col-lg-4 col-md-6" data-aos="fade-up">
										<div className="vps-feature-item bg-white deep-shadow position-relative zindex-1">
											...
											<div className="vps-ft-item-content mt-30">
												...
												<p>
													RedHost ofera exclusiv gazduire SSD (inclusiv NVMe) care ofera o viteza considerabil
													crescuta fata de gazduirea pe servere cu HDD-uri (indiferent de tipul acestora). Folosim
													SSD-uri Intel si Samsung profesionale (Datacenter edition) in matrice RAID-10 hardware.
												</p>
											</div>
										</div>
									</div>
									<div className="col-lg-4 col-md-6" data-aos="fade-up">
										<div className="vps-feature-item bg-white deep-shadow position-relative zindex-1">
											...
											<div className="vps-ft-item-content mt-30">
												...
												<p>
													{" "}
													In cazul in care achizitia reprezinta un upgrade, pretul este cel corespunzator perioadei
													de plata mai mica de 12 luni (deci pretul cel mai mare). Pachetul Promo este disponibil
													doar pentru comanda fara operator.{" "}
												</p>
											</div>
										</div>
									</div>
										...
										<div className="vps-feature-item bg-white deep-shadow position-relative zindex-1">
											...
											<div className="vps-ft-item-content mt-30">
												...
												<p>
													...
													copierea ca atare a contului. Nu putem muta un cont in alt cont sau un addon in alt cont.
													In cazul in care actualul server nu are cPanel va rugam sa ne contactati.
												</p>
											</div>
										</div>
									</div>
				...
				<section className="bg-white" style={{ backgroundColor: "#F6F9FF", padding: "120px 0px" }}>
					<div className="container">
						<div className="hm10-faq-tab">
							<div className="row">
								<div
									className="accordion hm2-accordion rounded-2 deep-shadow bg-white"
									id="accordion_1"
									data-aos="fade-up">
									<div className="accordion-item">
										<div className="accordion-header">
											<a href="#sh_1" data-bs-toggle="collapse">
												...
												<span style={{ marginLeft: "30px", marginTop: "30px" }}>Domenii</span>
											</a>
										</div>
										<div
											...
											<div className="accordion-body">
												...
												<p className="mb-10">
													Toate domeniile inregistrate prin RedHost (inclusiv cele obtinute gratuit impreuna cu un
													cont de gazduire), se inregistreaza doar pe numele clientului.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Certificate SSL
												</h6>
												<p className="mb-10">
													Conturile de gazduire RedHost ofera in mod gratuit certificate SSL emise de cPanel si
													semnate de catre Comodo. Aceste certificate NU sunt de tip self-signed. Sunt certificate
													recunoscute similare cu certificatele SSL uzuale de la Comodo dar ofera subdomenii in plus.
													Instalarea acestor certificate se face automat de catre cPanel (AutoSSL).
												</p>
												<div id="hide_display" className="d-none">
													...
													<p className="mb-10">
														RedHost ofera IP-uri dedicate pentru conturile de gazduire fie contra-cost, fie gratuit
														(in functie de pachetul ales).Alocarea IP-urilor dedicate gratuite se face doar la
														cerere.
													</p>
													<h6 className="mb-10" style={{ color: "#e71f30" }}>
														Domenii gratuite
													...
													<p className="mb-20">
														RedHost ofera domenii gratuite (domeniile oferite gratuit sunt identice cu cele platite)
														la pachetele de gazduire (cu exceptia pachetului Promo) platite anual.
													</p>
													...
													<ul>
														...
														<li>
															...
															RO/EU/COM/NET/ORG/BIZ pentru Smart sau RO/EU/COM/NET/ORG/BIZ/INFO pentru Pro in
															fiecare an de gazduire.
														</li>
														<li>
															Domeniul gratuit se ofera doar impreuna cu pachetul de gazduire aferent (pe aceeasi
															factura si contract deci nu ulterior) si acolo unde este in mod obiectiv posibil,
															doar pentru domeniul principal al contului de gazduire.
														</li>
														<li>
														...
														<li>
															...
															serverele RedHost in contul de gazduire impreuna cu care a fost primit gratuit.
															Pentru achizitionarea de domenii suplimentare accesati oferta de inregistrare
															domenii.
														</li>
													</ul>
												</div>
									...
									<div className="accordion-item">
										<div className="accordion-header">
											<a href="#sh_2" data-bs-toggle="collapse">
												...
												<span style={{ marginLeft: "30px", marginTop: "30px" }}>E-mail</span>
											</a>
										</div>
										<div className="accordion-collapse collapse" id="sh_2" data-bs-parent="#accordion_1">
											<div className="accordion-body">
												...
												<p className="mb-10">
													Conturile de gazduire shared pot utiliza simultan maxim 20 de conexiuni IMAP. Pentru
													conturile care depasesc acest numar de conexiuni simultane, putem oferi doar gazduire
													personalizata in functie de numarul de conexiuni IMAP mediu utilizat precum si de spatiul
													contractat.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Anti SPAM
												...
												<p className="mb-10">
													Conturile de gazduire au o limita de trimitere de 250 de mailuri pe ora.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Forwardere
												</h6>
												<p className="mb-10">
													Se ofera un numar de forwardere egal cu numarul conturilor de mail. Nu este permisa setarea
													de forwardere catre servicii externe de mail (Yahoo, GMail) pentru ca aceste servicii vor
													vedea SPAM-urile pe care le primiti pe adresele de pe serverul nostru si forwardate automat
													ca fiind spam-uri trimise de pe domeniul Dvs si de pe serverul nostru. Este deci necesar ca
									...
									<div className="accordion-item">
										<div className="accordion-header">
											<a href="#sh_3" data-bs-toggle="collapse" style={{ position: "relative" }}>
												...
												<span style={{ marginLeft: "30px", marginTop: "30px" }}>Management</span>
											</a>
										</div>
										<div className="accordion-collapse collapse" id="sh_3" data-bs-parent="#accordion_1">
											<div className="accordion-body">
												<p className="mb-20">
													CloudLinux este un kernel special destinat serverelor de hosting care asigura o izolare
													mult mai buna pentru site-urile gazduite. Astfel niciun site nu va monopoliza resursele
													serverului. Obtinem deci o performanta sporita si un uptime superior.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Administrare
												</h6>
												...
												<p className="mb-10">
													Oferim acces SSH doar in cazurile in care este necesar si doar pentru pachetele Balance,
													Smart si Pro. Accesul SSH oferit este de tip JailedShell si nu se activeaza implicit. Se
													activeaza doar la cerere.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Installatron (sute de aplicatii)
												</h6>
												<p className="mb-10">
													Puteti instala instantaneu: Drupal, Joomla, Magento, osCommerce, phpBB, SMF, Wordpress etc
													(in total sute de scripturi populare).
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													.htaccess
												</h6>
												...
												<p className="mb-10">
													Firma noastra este inscrisa in Sistemul Electronic de Achizitii Publice.
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													Upgrade
												</h6>
												...
												<p className="mb-10">
													...
													insa costurile domeniilor inregistrate pe care le veti pastra). Garantia de returnare se
													poate invoca doar in primele 30 de zile din prima perioada contractuala (nu se ofera cele
													30 de zile de garantie si pentru prelungiri sau reluari de contract).
												</p>
												<h6 className="mb-10" style={{ color: "#e71f30" }}>
													TVA
												</h6>
