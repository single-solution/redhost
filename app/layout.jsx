...
export default function RootLayout({ children }) {
	return (
		<html lang="en">
			...
			<Script defer src="/assets/js/vendors/bootstrap-slider.min.js" />
			<Script defer src="/assets/js/vendors/magnific-popup.min.js" />
			<Script defer src="/assets/js/vendors/waypoints.min.js" />
			<Script defer src="/assets/js/vendors/jquery.counterup.min.js" />
			<Script defer src="/assets/js/vendors/isotope.pkgd.min.js" />
