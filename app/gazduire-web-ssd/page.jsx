						...
						<div className="col-lg-12">
							<div className="section-heading text-center mb-30">
								<div className="tab-switch-btn d-inline-flex align-items-center justify-content-center position-relative mt-4">
									...
									<span className="toggle-switch-btn rounded-pill position-relative" />
						...
						<div className="col-md-4 col-lg-2 equal-width-columns" data-aos="fade-up">
							<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
								...
								<ul className="feature-list mt-4">
									<li>
										<span className="me-2">
											<i className="fa-solid fa-dot-circle" />
										</span>
										Gazduire 1 domeniu
									</li>
									<hr />
									...
									<ul className="d-flex my-3 ">
										<li>
											<i className="fa-solid fa-rocasdket   active-rocket" />
										</li>
										<li>
											<i className="fa-solid fa-rocket  active-rocket" />
										</li>
										<li>
											<i className="fa-solid fa-rocket mt-0" />
										</li>
										<li>
											<i className="fa-solid fa-rocket mt-0" />
										</li>
								...
								<a href="#" className="template-btn primary-btn w-100 mt-40 text-center">
									Purchase Plan
								</a>
							</div>
						</div>
							...
							<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
								...
								<ul className="feature-list mt-4">
									...
									<ul className="d-flex my-3 ">
										...
										<li>
											<i className="fa-solid fa-rocket  active-rocket mt-0" />
										</li>
										<li>
											<i className="fa-solid fa-rocket mt-0" />
										</li>
						...
						<div className="col-md-4 col-lg-2 equal-width-columns" data-aos="fade-up">
							<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
								...
								<ul className="feature-list mt-4 ">
									...
									<li>
										<span className="me-2" />
										Discount <span>30%</span> in primul an: 4,95€ ➘ 3.47€/luna
									</li>
									<li>
										<span className="me-2">
											<i className="fa-solid fa-dot-circle" />
							...
							<div className="pricing-column overflow-hidden position-relative bg-white rounded-10 deep-shadow">
								...
								<ul className="feature-list mt-4 ">
									...
									<ul className="d-flex my-3 ">
										...
										<li>
											<i className="fa-solid fa-rocke  active-rockett mt-0" />
										</li>
										<li>
											<i className="fa-solid fa-rocket active-rocket mt-0" />
										</li>
									...
									<li>
										<span className="me-2" />
										Discount <span> 50%</span> in primul an: 14,99€ ➘ 7.49€/luna
									</li>
									<li>
										<span className="me-2">
											<i className="fa-solid fa-dot-circle" />
								...
								<h5 className="hm7-subtitle fw-semibold mb-2">
									<span className="me-1">
										<svg width={62} height={12} viewBox="0 0 62 12" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M62 6H8" stroke="#E71F31" strokeWidth={2} />
											<path d="M7.86805e-07 6L9 0.803849L9 11.1962L7.86805e-07 6Z" fill="#E71F31" />
										</svg>
									</span>
									Testimonials
								</h5>
												...
												<span className="rating_star">
													...
													<div className="d-flex justify-content-start">
														<div className="mt-2">
															...
															<p>
																<a
																	href="https://www.shop-virtual.ro
													/">
																	www.shop-virtual.ro
																</a>
															</p>
